...
const ContactUs = (props) => {
  const handleFormSubmit = (event) => {
    ...
    const mailtoLink = `mailto:contactus_fitAi@​yahoo.com?subject=${subject}&body=${encodeURIComponent(emailBody)}`;
    ...
    <div>
      <Container maxWidth="sm" style={{ textAlign: 'center', marginTop: '60px' }}>
        ...
        <Typography variant="h5" align="justify" color="text.primary" paragraph>
          Use the email below to contact the fitAi development team. Feel free to reach out to us for any questions, feedback, or inquiries.
          <br></br><br></br>
          Fill out the form below to send us an email.
        </Typography>
        <Typography variant="h6" style={{ marginTop: '20px' }}>
          Email: <Link href="contactus_fitAi@​yahoo.com">contactus_fitAi@​yahoo.com</Link>
        </Typography>
        ...
        <form style={{ marginTop: '20px' }} onSubmit={handleFormSubmit}>
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            style={{ marginTop: '20px', backgroundColor: 'var(--green)', color: 'white' }}
          >
            Submit
          </Button >
        </form>
